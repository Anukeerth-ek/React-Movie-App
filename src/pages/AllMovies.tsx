...
const AllMovies = () => {
  ...
  // const isAlreadyFavorite = favoriteMovies.some(movie => movie.id === item.id);
  ...
  //   } else {
  //     dispatch(addFavoriteMovie(item.id));
  //   }
  ...
  return (
    ...
    {filteredMovies.map((item, index)=> (
        <div className="border w-[330px] md:w-[280px] cursor-pointer mt-3 md:mr-3 p-2 pb-3 relative bg-[#131c31]" >
        <div className='w-[312px] md:w-[262px] relative hover:scale-105 duration-300'>
          ...
          <img src={item.thumbnail} className='w-full h-[190px] object-fill hover:bg-black rounded-md' />
        </div>
